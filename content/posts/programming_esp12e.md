...
date: 2023-01-25T:30:03+00:00
# weight: 1
# aliases: ["/first"]
tags: ["ESP8266", "IOT", "Boot Modes", "Programming", "Bolt IOT"]
author: "Me"
...
{{<figure src="/images/blogs/bolt_iot/wemos_dmesg_output.png" loading="eager" align="center" caption="dmesg output when the Wemos D1 Mini board was connected. It shows that the Kernel is loading the drivers for the FT232RL USB-to-UART">}}
...
{{<figure src="/images/blogs/bolt_iot/wemos_no_name.png" loading="eager" align="center" width=400 caption="The Wemos D1 Mini board backside that shows the USB-to-UART chip with no name">}}
...
{{<figure src="/images/blogs/bolt_iot/blow-mind.gif" loading="eager" align="center" caption="">}}
...
{{<figure src="/images/blogs/bolt_iot/bolt_iot_1.jpg" width=600 loading="eager" align="center" caption="The Bolt IOT wifi module">}}
...
{{<figure src="/images/blogs/bolt_iot/esp12e_pinout.jpg" loading="eager" align="center" caption="ESP-12E module pinout. Credits: Random Nerd Tutorials">}}
...
{{<figure src="/images/blogs/bolt_iot/schematic.png" loading="eager" align="center" caption="A schematic of the setup I made. It does not show the connections of the Bolt IOT module like the voltage regulator, on-board LEDs, etc.">}}
...
{{<figure src="/images/blogs/bolt_iot/module_wires_soldered.jpg" width=600 loading="eager" align="center" caption="The Bolt IOT wifi module with the wires soldered on required GPIOs">}}
{{<figure src="/images/blogs/bolt_iot/perf_board_without_module.jpg" width=600 loading="eager" align="center" caption="">}}
{{<figure src="/images/blogs/bolt_iot/perf_board_with_module.jpg" width=600 loading="eager" align="center" caption="Above schematic on soldered on a perf board">}}

And here are some images of the final project:
{{<figure src="/images/blogs/bolt_iot/cover-3.jpg" width=600 loading="eager" align="center" caption="">}}
{{<figure src="/images/blogs/bolt_iot/box.jpg" width=600 loading="eager" align="center" caption="">}}
