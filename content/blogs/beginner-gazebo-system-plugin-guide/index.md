...
{{Add github shortcode for the repo}}
...
## User Perspective and How Does it Work?
...
<!-- Show a gif that shows a blinking light in a sample world only with LED not visual -->
